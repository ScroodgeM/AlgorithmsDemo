...
namespace AlgorithmsDemo.Dungeon
{
            ...
            for (int s = 0; s < steps; s++)
            {
                ...
                switch (Random.Range(0, 4))
                {
                    case 0:
                        ...
                        distanceLeft = Random.Range(0, size.y);
                        break;
                    case 1:
                    ...
                    case 2:
                        ...
                        distanceLeft = Random.Range(0, size.x);
                        break;
                    case 3:
                ...
                while (true)
                {
                    ...
                    {
                        // out of range, stop moving and go to next step, starting from center
                        cursor = size / 2;
                        break;
                    }
